    ...
    constructor(
        ...
        if (props.smsOtpStepUp) {
            Object.assign(createAuthChallengeEnvironment, {
                ...
                OTP_LENGTH: props.smsOtpStepUp.otpLength ? props.smsOtpStepUp.otpLength.toString() : "",
        ...
        [this.kmsKey, props.magicLink?.rotatedKmsKey].forEach((key) => {
            ...
            if ((key as cdk.aws_kms.IAlias).aliasName) {
                const permissions = {
                    ...
                    conditions: {
                        StringLike: {
                            "kms:RequestAlias": (key.node.defaultChild as cdk.aws_kms.CfnAlias).aliasName, // have to get the raw string like this to prevent a circulair dependency
                        },
                    },
                };
        ...
        if (props.fido2) {
            Object.assign(verifyAuthChallengeResponseEnvironment, {
                ...
                ENFORCE_FIDO2_IF_AVAILABLE: props.fido2?.enforceFido2IfAvailable ? "TRUE" : "",
                USER_VERIFICATION: props.fido2.userVerification ?? "required",
                STACK_ID: cdk.Stack.of(scope).stackId,
            });
        }
        ...
        this.verifyAuthChallengeResponseFn = new cdk.aws_lambda_nodejs.NodejsFunction(
            this,
        ...
        this.defineAuthChallengeResponseFn = new cdk.aws_lambda_nodejs.NodejsFunction(
            this,
        ...
        if (props.clientMetadataTokenKeys) {
            this.preTokenGenerationFn = new cdk.aws_lambda_nodejs.NodejsFunction(
                ...
                `PreToken${id}`,
                {
                    ...
                    environment: {
                        LOG_LEVEL: props.logLevel ?? "INFO",
                        CLIENT_METADATA_PERSISTED_KEYS: ["signInMethod", ...(props.clientMetadataTokenKeys ?? [])].join(","),
        ...
        if (props.fido2) {
            ...
            this.fido2Fn = new cdk.aws_lambda_nodejs.NodejsFunction(
                ...
                `Fido2${id}`,
                {
                    ...
                    environment: {
                        ...
                        AUTHENTICATOR_REGISTRATION_TIMEOUT: props.fido2.timeouts?.credentialRegistration?.toString() ?? "300000",
                        ...
                        CORS_MAX_AGE: defaultCorsOptionsWithAuth.maxAge.toSeconds().toString(),
            ...
            this.fido2challengeFn = new cdk.aws_lambda_nodejs.NodejsFunction(
                ...
                `Fido2Challenge${id}`,
                {
                    ...
                    environment: {
                        ...
                        CORS_MAX_AGE: defaultCorsOptionsWithoutAuth.maxAge.toSeconds().toString(),
                    ...
                    deployOptions: {
                        ...
                        accessLogFormat: cdk.aws_apigateway.AccessLogFormat.custom(
                            JSON.stringify({
                                ...
                                jwtSub:
                                    cdk.aws_apigateway.AccessLogField.contextAuthorizerClaims("sub"),
            ...
            startResource.addMethod("POST", undefined, {
                ...
                requestParameters: {"method.request.querystring.rpId": true},
                requestValidator,
            });
