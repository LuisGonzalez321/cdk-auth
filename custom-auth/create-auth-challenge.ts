import {CreateAuthChallengeTriggerHandler, CreateAuthChallengeTriggerEvent,} from "aws-lambda";
...
async function provideAuthParameters(event: CreateAuthChallengeTriggerEvent): Promise<void> {
