...
let config = {
    ...
    challengeGenerator: (): Promise<string> | string => randomBytes(64).toString("base64url"),
...
function requireConfig<K extends keyof typeof config>(k: K): NonNullable<(typeof config)[K]> {
...
export async function addChallengeToEvent(event: CreateAuthChallengeTriggerEvent) {
